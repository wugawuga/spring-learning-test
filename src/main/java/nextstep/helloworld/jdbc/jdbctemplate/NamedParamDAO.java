...
public class NamedParamDAO {
    ...
    public int useMapSqlParameterSource(String firstName) {
        ...
        MapSqlParameterSource sqlParameterSource = new MapSqlParameterSource("first_name", firstName);
    ...
    public int useBeanPropertySqlParameterSource(Customer customer) {
        ...
        BeanPropertySqlParameterSource propertySqlParameterSource = new BeanPropertySqlParameterSource(customer);

        return namedParameterJdbcTemplate.queryForObject(sql, propertySqlParameterSource, Integer.class);
    }
}
